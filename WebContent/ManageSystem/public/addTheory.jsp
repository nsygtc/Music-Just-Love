...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="style/images/title_arrow.gif"/> 添加新乐理信息
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="../Theory?method=addTheory" method="post" >
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					...
					<tr>
							...
							<td><input type="text" id="musicTheory_name" name="musicTheory_name" class="InputStyle" value=""/> *</td>
						</tr>	
                    <tr>
							<td width="80px">内容概述</td>
							<td><input type="text" id="musicTheory_content" name="musicTheory_content" class="TextareaStyle" /> </textarea>*</td>
						</tr>
						
						
                        <tr>
							<td>上传者学号</td>
							<td><input type="text" id="musicTheory_host" name="musicTheory_host" class="InputStyle" /> *</td>
						</tr>
				...
				<!-- 		<tr>
							<td >内容详情链接地址</td>
								<td><input type="text" id="" class="InputStyle">*</td> -->
